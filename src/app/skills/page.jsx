    ...
    <div className={styles.main}>
        ...
        <ul id="myList" className={isListOpen ? styles.visibleList : styles.hiddenList}>
          ...
          <div className={styles.skills}>
            <Image
              ...
              alt="Icone React"
            />
            <p className={styles.css}>ReactJS</p>
          </div>
          <div className={styles.skills}>
            <Image
              src="/node.png"
          ...
          <div className={styles.skills}>
            <Image
              src="/icons8-expo-250.png"
              width={20}
              height={20}
              alt="Icone Expo"
            />
            <p className={styles.css}>Expo</p>
          </div>
          <div className={styles.skills}>
            <Image
              src="/icons8-express-js-48.png"
              width={20}
              height={20}
              alt="Icone Express"
            />
            <p className={styles.css}>Express</p>
          </div>
          <div className={styles.skills}>
            <Image
              src="/sequelize-icon-md.png"
              width={20}
              height={20}
              alt="Icone Sequelize"
            />
            <p className={styles.css}>Sequelize</p>
          </div>
          <div className={styles.skills}>
            <Image
              src="/react.png"
            ...
            />
            <p className={styles.css}>React Native</p>
          </div>
          <div className={styles.skills}>
            <Image
            ...
            />
            <p className={styles.css}>PostgreSQL</p>
          </div>
        </ul>
      </div>
      <div className={styles.quadranteTwo}>
        ...
        <div className={styles.imgPlusText}>
          <h1>Sequelize</h1>
          <Image
            src="/sequelize_plain_logo_icon_146346.png"
            width={100}
            height={100}
            alt="Icone sequelize"
          />
